...
-- Uses IF NOT EXISTS so this is safe to run against Supabase (already has these tables)
...
CREATE TABLE IF NOT EXISTS public.units (
    ...
    line_number integer,
    warranty_start_date date,
    commission_level text DEFAULT 'none',
    description text,
    notes text,
    asset_tag text,
    system_id uuid,
...
CREATE TABLE IF NOT EXISTS public.commissioning_projects (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    site_id uuid,
    project_name text,
    start_date date,
    ...
    updated_at timestamp without time zone DEFAULT now(),
    unit_id uuid,
    l1_completed_by text,
    l2_completed_by text,
    l3_completed_by text,
    l4_completed_by text,
    l5_completed_by text,
    l1_checklist_url text,
    l2_checklist_url text,
    l3_checklist_url text,
    l4_checklist_url text,
    l5_checklist_url text,
    l1_checklist_filename text,
    l2_checklist_filename text,
    l3_checklist_filename text,
    l4_checklist_filename text,
    l5_checklist_filename text,
...
CREATE TABLE IF NOT EXISTS public.unit_components (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.component_updates (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.equipment_history (
    ...
    description text,
    component_name text,
    old_component_serial text,
    new_component_serial text,
    part_number text,
    performed_by uuid,
    work_order_id uuid,
...
CREATE TABLE IF NOT EXISTS public.site_address_history (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    site_id uuid NOT NULL,
    old_address text,
    old_city text,
...
CREATE TABLE IF NOT EXISTS public.site_form_templates (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    site_id uuid NOT NULL,
    name text NOT NULL,
    description text,
...
CREATE TABLE IF NOT EXISTS public.site_job_numbers (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    site_id uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.sycool_systems (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    site_id uuid NOT NULL,
    data_hall text NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.unit_campaign_status (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.unit_programs (
    id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    unit_id uuid NOT NULL,
