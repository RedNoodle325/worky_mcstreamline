      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 16 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <Link href="/issues" style={{ fontSize: 10, color: '#ffffff55', textDecoration: 'none', letterSpacing: 1 }}>
              VIEW ALL →
            </Link>
          </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <Link href="/todos" style={{ fontSize: 10, color: '#ffffff55', textDecoration: 'none', letterSpacing: 1 }}>
              VIEW ALL →
            </Link>
          </div>
